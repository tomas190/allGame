...
declare global {
	export interface hqqinterface {
		...
		imgLoad(node:any, path:string);
		getTip(tipname:string);
		btnLoad(node:any, normal:any, pressed?:any, interactable?:boolean);
		editboxTipLoad(node:any, tipname:string);
		skeletonLoad(node:any, path:any, aniname:string, loop:boolean,Res?:any);
		setWidget(node:any, config:any);
		addNode(node:any, cfg:any);
		setSprite(node:any, cfg:any);
		setBtn(node:any, cfg:any);
		setToggle(node:any, cfg:any);
		setLabel(node:any, cfg:any);
		setSkeleton(node:any, cfg:any);
		setEditbox();
		setScrollView(node:any, cfg:any);
		checkNode(node:any);
		setNode(node:any, cfg:any);
