cc.Class({
    ...
    setGameTimer: function(e) {
        ...
        if (this.flag = e.flag, this.onTimerMessageFunc_ = e.onTimerMessageFunc, this.node.active = this.flag, !i || i <= 0)
    ...
    onKillTimer: function() {
        //this.updateTimer && (this.unschedule(this.updateTimer), this.updateTimer = null)
        this._LeftCount = 0;
        this.node.active = !1;
        this.timeCount.string = "0";
    }
})