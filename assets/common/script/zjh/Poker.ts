...
export default class NewClass extends cc.Component {
    ...
    setRealValue()
    {
        this.realValue = Math.floor(this.logicValue/4);
    }
    ...
    setFlowerValue()
    {
     ...
     setPokerFace()
     {
         ...
         CommonTool.loadSpriteFrame(this.num,numberUrl);
         var smallUrl = "poker/card_color_s_"+this.flowerValue
         CommonTool.loadSpriteFrame(this.sf,smallUrl);
         if(this.realValue > 10 && this.realValue < 14){
            CommonTool.loadSpriteFrame(this.bf2,"poker/b_"+this.flowerValue+"_"+this.realValue);
            this.bf.active = false;
            this.bf2.active = true;
         }else{
            CommonTool.loadSpriteFrame(this.bf,"poker/card_color_b_"+this.flowerValue);
            this.bf.active = true;
