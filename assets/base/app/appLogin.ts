...
export let appLogin = {
    init: function (data) {
        ...
        this.hallversionList = [ "test","xingba","nineone","xinhao","huangshi","tianqi","tetu","xingyao"];
        this.proxyversionList = [ "test"];
        this.IMversionList = [];
        this.payversionList = [ "test","xingba","nineone","xinhao","huangshi","chaofan"];
        this.newpaypinpailist = ["fuxin","jiaxing","fiveone","test","wansheng","letian","huaxing","letian","xinlong","juding","debi","ninetwo","tianqi","xingui","xinsheng","fiveone","ninethree"];
        ...
        if(hqq.app.pinpai === "debi"){
            ...
            hqq.subModel.pay.lanchscene = "payRecharge15";
            hqq.subModel.cash.lanchscene = "payCash15";
        }
    ...
    requestUpgradeInfo() {
        let callback = (response, url) => {
            ...
            hqq.eventMgr.dispatch(hqq.eventMgr.showNetStateNode, { parent: pn, position: { x: 0, y: 0 } ,isLoading:true})
        }
        let failcallback = (status, forcejump, url, err, readyState) => {
