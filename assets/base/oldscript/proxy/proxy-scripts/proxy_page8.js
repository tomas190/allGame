...
cc.Class({
    ...
    careful() {
        ...
        let game_4 = this.node.getChildByName('banner').getChildByName('Newlay').getChildByName('sx')
        game_1.active = false
        game_2.active = false
        game_3.active = false
        game_4.active = false
    ...
    checkMyAgents(event, num) {
        ...
        let game_2 = this.node.getChildByName('banner').getChildByName('Newlay').getChildByName('cp').getChildByName('cp_di')
        let game_3 = this.node.getChildByName('banner').getChildByName('Newlay').getChildByName('ty').getChildByName('ty_di')
        let game_4 = this.node.getChildByName('banner').getChildByName('Newlay').getChildByName('sx').getChildByName('sx_di')
