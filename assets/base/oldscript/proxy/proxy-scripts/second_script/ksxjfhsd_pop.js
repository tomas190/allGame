    ...
    setmydata(obj) {
        ...
        if (obj != null) {
            for (let i = 0; i < obj.length; i++) {
                ...
                //  cc.log('obj[i]====',obj[i]);
                if (obj[i].game_tag == commonVal.gametags && obj[i].type == 2) {
                    let content = ''
    ...
    setdata(obj) {
        ...
        if (this.data != [] && this.data != null) {
            ...
            for (let index = 0; index < this.data.length; index++) {
                ...
                this.tittle.string = '统计方式: ' + content + ', 统计范围: ' + tag + ".";
                item.getComponent(cc.Label).string = "规则" + st + "：周期量(半月量)大于等于";
        ...
        this.new_gz.on("touchend", (event) => {
            ...
            gzsd_pop.getComponent("ks_gzsd_script").savedata(this.now_id, this.gz_length)

            gzsd_pop.getComponent("ks_gzsd_script").setdata() //设置规则设定中自己的界面
