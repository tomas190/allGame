...
cc.Class({
    ...
    setdata(obj) {
        ...
        this.new_gz.on("touchend", (event) => {
            ...
            gzsd_pop.getComponent("ks_gzsd_script_p6").savedata(this.now_id, this.gz_length)
            let account_name = gHandler.gameGlobal.player.account_name;
            gzsd_pop.getComponent("ks_gzsd_script_p6").getDividendRule(account_name) //设置规则设定中自己的界面
