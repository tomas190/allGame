...
let appGlobal = {
    ...
    payVersionKey: "payVersionKey",
    payVersion: "1.0.0",

    proxyVersionKey: "proxyVersionKey",
    proxyVersion: "1.0.0",

    IMVersionKey: "IMVersionKey",
    IMVersion: "1.0.0",
    ...
    checkSubServer() {
        ...
        if (url.includes("center")) {
            ...
            // gHandler.gameGlobal.pay.pay_host = 'http://gocz.539316.com'
        }
        // console.log("pay_host地址", gHandler.gameGlobal.pay.pay_host)
