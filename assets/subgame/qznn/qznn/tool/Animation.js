var Animation = cc.Class({
    ...
    setGoldAnimation: function (e, t, i, a, o, n, s) {
        ...
        if (null == a || a.length <= 0) return n && n(),
            void (s ? cc.gg.audioMgr.playSFX("sg_ss/game/drop_gold.mp3") : cc.gg.audioMgr.playSFX("language/CN/nnMusic/gold"));
                ...
                var _ = [cc.v2(0, g.x), cc.v2(g.x, g.y), cc.v2(g.x, g.y)],
                    ...
                    f = cc.sequence(p, cc.callFunc(function () {
                        ++r == 15 * a.length - 1 && (e.removeAllChildren(),
                            n && n(),
                            s ? cc.gg.audioMgr.playSFX("sg_ss/game/drop_gold.mp3") : cc.gg.audioMgr.playSFX("language/CN/nnMusic/gold"))
                    }));
                m.runAction(f)
            }
        if (s) cc.gg.audioMgr.playSFX("sg_ss/game/drop_gold.mp3");
        else { cc.gg.audioMgr.playSFX("language/CN/nnMusic/gold") }
    },
