...
cc.Class({
            ...
            if (xhr.readyState == 4 && xhr.status === 200) {
                ...
                if (resData.code === 200) {
                    ...
                    cc
                        ...
                        .getComponent("cc.Label").string = resData.msg.proxy_user.balance.toFixed(
                        2,
                    );
                    //渲染表格数据
    ...
    transfermoney: function () {
        ...
        console.log("/proxy/user/moveBalanceToProxy请求:", sendData);
        xhr.send(sendData);
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status === 200) {
                var resData = JSON.parse(xhr.responseText);
                console.log("/proxy/user/moveBalanceToProxy返回:", resData);
                if (resData.code === 200) {
