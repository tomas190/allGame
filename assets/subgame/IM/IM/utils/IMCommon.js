cc.Class({
    ...
    //滚动条监听事件
    addScrollToBottom: function (t, i, a) {
        t.on("scroll-to-bottom", function (e) {
            i && i(t, e, a)
        })
    },
    ...
    changeSpriteFrameWithServerUrlForWeb: function (a, o) {
        ...
        if (cc.gg.global.isH5) {
            ...
            var iconPath = cc.gg.global.iconPath;
        }
     ...
     * @param {头像链接} head_img 
     */
    getUserImgSourceByNumber: function (playerImg,callBack) {
