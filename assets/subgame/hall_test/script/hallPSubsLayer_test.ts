...
export class hallPSubsLayer_test extends cc.Component {
    ...
    onLoad() {
        this.usdtnode = cc.find("Canvas/smallsublayer/bindusdt");
        this.proxycode = cc.find("Canvas/smallsublayer/proxycode");
        this.register = cc.find("Canvas/smallsublayer/register");
        this.changehead = cc.find("Canvas/smallsublayer/changehead");
        this.bindalipay = cc.find("Canvas/smallsublayer/bindalipay");
        this.nickchange = cc.find("Canvas/smallsublayer/nickchange");
        this.login = cc.find("Canvas/smallsublayer/login");
        this.nologin = cc.find("Canvas/smallsublayer/nologin");
        this.download = cc.find("Canvas/smallsublayer/download");
        this.tiplayer = cc.find("Canvas/smallsublayer/tiplayer");
        this.tiplayerinfo = cc.find("Canvas/smallsublayer/tiplayer/info").getComponent(cc.Label);
        this.imnode = cc.find("Canvas/smallsublayer/imnode");
        this.exitbtn = cc.find("Canvas/smallsublayer/p_close");
        this.surecg = cc.find("Canvas/smallsublayer/surecg");
        this.headscroll = cc.find("Canvas/smallsublayer/changehead/headscroll").getComponent(cc.ScrollView);
        this.headitem = cc.find("Canvas/smallsublayer/changehead/item");
        this.weblogin = cc.find("Canvas/smallsublayer/weblogin");
        this.setting = cc.find("Canvas/smallsublayer/setting");
        this.login2 = cc.find("Canvas/smallsublayer/login2");
    }
    ...
    UILoad() {
        ...
        this.back = cc.find("Canvas/smallsublayer/p_bandalibg")
        let closebtn = cc.find("Canvas/smallsublayer/p_close")
        let surecg = cc.find("Canvas/smallsublayer/surecg")
        let title_changehead = cc.find("Canvas/smallsublayer/changehead/title_changehead")
        let titile_tip = cc.find("Canvas/smallsublayer/nickchange/titile_tip")
        let inputurnickname = cc.find("Canvas/smallsublayer/nickchange/inputurnickname")
        let nickeditbox = cc.find("Canvas/smallsublayer/nickchange/nickeditbox")
        if (hqq.app.pinpai === "juding") {
            hqq.editboxTipLoad(nickeditbox, "changenickname")
        } else {
            hqq.editboxTipLoad(nickeditbox, "largelen")
        }
        let title_login = cc.find("Canvas/smallsublayer/login/title_login")
        let txt_forgetpwd = cc.find("Canvas/smallsublayer/login/txt_forgetpwd")
        let login_form = cc.find("Canvas/smallsublayer/login/login_form")
        let phoneeditboxnode = cc.find("Canvas/smallsublayer/login/phoneeditbox")
        let passeditboxnode = cc.find("Canvas/smallsublayer/login/passeditbox")
        hqq.editboxTipLoad(phoneeditboxnode, "enteridorphone")
        hqq.editboxTipLoad(passeditboxnode, "enterpass")
        let label = cc.find("Canvas/smallsublayer/nologin/label")
        label.getComponent(cc.Label).string = hqq.getTip("accontloginother")
        let copybtn = cc.find("Canvas/smallsublayer/download/copybtn")
        let downlabel = cc.find("Canvas/smallsublayer/download/downlabel")
        downlabel.getComponent(cc.Label).string = hqq.getTip("reinstall")
        let downlabel2 = cc.find("Canvas/smallsublayer/download/downlabel2")
        downlabel2.getComponent(cc.Label).string = hqq.getTip("downtip")
        let btnlabel = cc.find("Canvas/smallsublayer/download/copybtn/btnlabel")
        btnlabel.getComponent(cc.Label).string = hqq.getTip("copy")
        let title = cc.find("Canvas/smallsublayer/imnode/title")
        let weblabel = cc.find("Canvas/smallsublayer/imnode/web/weblabel")
        let applabel = cc.find("Canvas/smallsublayer/imnode/app/applabel")
        let webbtn = cc.find("Canvas/smallsublayer/imnode/web")
        let appbtn = cc.find("Canvas/smallsublayer/imnode/app")
        let accountnode = cc.find("Canvas/smallsublayer/register/account")
        hqq.editboxTipLoad(accountnode, "enteraccount")
        let pass0node = cc.find("Canvas/smallsublayer/register/pass0")
        hqq.editboxTipLoad(pass0node, "pass0")
        let pass1node = cc.find("Canvas/smallsublayer/register/pass1")
        hqq.editboxTipLoad(pass1node, "pass1")
        let registertitle = cc.find("Canvas/smallsublayer/register/title")
        registertitle.getComponent(cc.Label).string = hqq.getTip("registertitle")
        let title0 = cc.find("Canvas/smallsublayer/register/title0")
        title0.getComponent(cc.Label).string = hqq.getTip("account")
        let tip0 = cc.find("Canvas/smallsublayer/register/tip0")
        tip0.getComponent(cc.Label).string = hqq.getTip("tip0")
        let title1 = cc.find("Canvas/smallsublayer/register/title1")
        title1.getComponent(cc.Label).string = hqq.getTip("title1")
        let tip1 = cc.find("Canvas/smallsublayer/register/tip1")
        tip1.getComponent(cc.Label).string = hqq.getTip("tip1")
        let title2 = cc.find("Canvas/smallsublayer/register/title2")
        title2.getComponent(cc.Label).string = hqq.getTip("title2")
        let info = cc.find("Canvas/smallsublayer/proxycode/info")
        info.getComponent(cc.Label).string = hqq.getTip("proxy")
        let codeeditboxnode = cc.find("Canvas/smallsublayer/proxycode/codeeditbox")
        hqq.editboxTipLoad(codeeditboxnode, "enterproxy")
        let usdttitle = cc.find("Canvas/smallsublayer/bindusdt/title_usdt")
        let usdteditboxback = cc.find("Canvas/smallsublayer/bindusdt/popup_usdt_frame")
        this.usdtadress = cc.find("Canvas/smallsublayer/bindusdt/adress")
        hqq.editboxTipLoad(this.usdtadress, "usdtaddress")
        let usdttip = cc.find("Canvas/smallsublayer/bindusdt/tishi")
        usdttip.getComponent(cc.Label).string = hqq.getTip("usdttip")
        this.usdttype = cc.find("Canvas/smallsublayer/bindusdt/type")
        ...
        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz"), { callback: "onSettingMenuClick", script: this, custom: 1 });
        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yylxradio/toggle1"), { callback: "onPlayBG", script: this, custom: 1 });
        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yylxradio/toggle2"), { callback: "onPlayBG", script: this, custom: 2 });
        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yylxradio/toggle3"), { callback: "onPlayBG", script: this, custom: 3 });
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/settinganiu"), { callback: "onSettingChangeAccountCallback", script: this });
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yy"), { callback: "onClicktxt_bgm", script: this });
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yx"), { callback: "onClicktxt_se", script: this });

        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm"), { callback: "onSettingMenuClick", script: this, custom: 2 });
        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1"), { callback: "onSettingDLMMTabCallback", script: this, custom: 1 });
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/settinganiu"), { callback: "resetpassEnsure", script: this })
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/getcodebtn"), { callback: "onClickGetCaptcha2", script: this, custom: 1 })
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/imgback/captchaimg"), { callback: "onClickCaptcha", script: this })

        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2"), { callback: "onSettingDLMMTabCallback", script: this, custom: 2 });
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/settinganiu"), { callback: "onSettingAQMCallback", script: this })
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/getcodebtn"), { callback: "onClickGetCaptcha2", script: this, custom: 2 })
        hqq.setBtn(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/imgback/captchaimg"), { callback: "onClickCaptcha", script: this })

        hqq.setToggle(cc.find("Canvas/smallsublayer/setting/btncontainer/appgx"), { callback: "onSettingMenuClick", script: this, custom: 4 });

        hqq.setToggle(cc.find("Canvas/smallsublayer/login2/tabToggleContainer/toggle1"), { callback: "onSettingLoginTabCallback", script: this, custom: 1 });
        hqq.setToggle(cc.find("Canvas/smallsublayer/login2/tabToggleContainer/toggle2"), { callback: "onSettingLoginTabCallback", script: this, custom: 2 });
        hqq.setBtn(cc.find("Canvas/smallsublayer/login2/settinganiu"), { callback: "onSettingLoginCallback", script: this, custom: 4 })
        hqq.setBtn(cc.find("Canvas/smallsublayer/login2/forgetpass"), { callback: "onClickForgetPass", script: this, custom: 4 })
        ...
        if (hqq.app.pinpai == "fuxin") {
            ...
            let changehead_di = cc.find("Canvas/smallsublayer/changehead/changehead_di")
            ...
            let login = cc.find("Canvas/smallsublayer/login")
            login.active = true;
            ...
            let rlogin_form = cc.find("Canvas/smallsublayer/register/login_form")
            rlogin_form.active = false
            let login_form1 = cc.find("Canvas/smallsublayer/register/login_form1")
            login_form1.active = false
            let register = cc.find("Canvas/smallsublayer/register")
            ...
            let bindusdt = cc.find("Canvas/smallsublayer/bindusdt")
            ...
            let login = cc.find("Canvas/smallsublayer/login")
            login.active = true;
            hqq.addNode(login, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: -1, width: 560, widget: { closetop: true, closeleft: true, closeright: true, closebottom: true }, y: 100, type: cc.Sprite.Type.SLICED })
            ...
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
            ...
            hqq.addNode(cc.find("Canvas/smallsublayer/nickchange"), { string: "nickchangetitle", x: 0, y: 255, bold: true, fontSize: 45, lineHeight: 50, color: cc.color(242, 222, 149) })
            ...
            // login.getChildByName("phoneeditbox").getChildByName("TEXT_LABEL").color = cc.color(84,98,119,255);
            login.getChildByName("phoneeditbox").getChildByName("TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
            // login.getChildByName("phoneeditbox").getChildByName("PLACEHOLDER_LABEL").color = cc.color(84,98,119,255);
            login.getChildByName("phoneeditbox").getChildByName("PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;

            // login.getChildByName("passeditbox").getChildByName("TEXT_LABEL").color = cc.color(84,98,119,255);
            login.getChildByName("passeditbox").getChildByName("TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
            // login.getChildByName("passeditbox").getChildByName("PLACEHOLDER_LABEL").color = cc.color(84,98,119,255);
            login.getChildByName("passeditbox").getChildByName("PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
            ...
            hqq.addNode(register, { path: bpath + "4", zIndex: -2, width: 630, height: 64, x: 25, y: 150, type: cc.Sprite.Type.SLICED })
            hqq.addNode(register, { path: bpath + "4", zIndex: -2, width: 630, height: 64, x: 25, y: 40, type: cc.Sprite.Type.SLICED })
            hqq.addNode(register, { path: bpath + "4", zIndex: -2, width: 630, height: 64, x: 25, y: -70, type: cc.Sprite.Type.SLICED })
            hqq.addNode(register, { path: bpath + "19", zIndex: -1, x: -250, y: 150 })
            hqq.addNode(register, { path: bpath + "21", zIndex: -1, x: -250, y: 40 })
            hqq.addNode(register, { path: bpath + "18", zIndex: -1, x: -250, y: -70 })
            ...
            // cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").color = cc.color(84,98,119,255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
            // cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").color = cc.color(84,98,119,255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
            ...
            if (this.data.type == 10) {
                ...
                this.captchaimg = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/imgback/captchaimg").getComponent(cc.Sprite);
                this.captchaimg2 = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/imgback/captchaimg").getComponent(cc.Sprite);
                surecg.active = false;
                this.dlmmtabindex = 1;
            ...
            let headscroll = cc.find("Canvas/smallsublayer/changehead/headscroll");
            ...
            // hqq.setSprite(titile_tip, { path: hlpath + "jd_popup_title_changeNickname", x:-315,y: 225 })
            titile_tip.active = false;
            hqq.addNode(cc.find("Canvas/smallsublayer/nickchange"), { string: "nickchangetitle", x: 0, y: 190, bold: true, fontSize: 45, lineHeight: 50, color: cc.color(242, 222, 149) })
            ...
            let phoneeditbox = cc.find("Canvas/smallsublayer/login/phoneeditbox");
            ...
            let passeditbox = cc.find("Canvas/smallsublayer/login/passeditbox");
            ...
            let register = cc.find("Canvas/smallsublayer/register")
            register.active = true;
            hqq.addNode(register, { path: bpath + "kuangti1", zIndex: -2, width: 750, height: 300, x: 0, y: 30, type: cc.Sprite.Type.SLICED })
            let registerinput1 = hqq.addNode(register, { path: bpath + "yjks", zIndex: -1, width: 400, height: 45, x: -80, y: 135 })
            hqq.addNode(registerinput1, { path: bpath + "shouji", x: -170 })
            let registerinput2 = hqq.addNode(register, { path: bpath + "yjks", zIndex: -1, width: 400, height: 45, x: -80, y: 30 })
            hqq.addNode(registerinput2, { path: bpath + "gfdsg", x: -170 })
            let registerinput3 = hqq.addNode(register, { path: bpath + "yjks", zIndex: -1, width: 400, height: 45, x: -80, y: -60 })
            ...
            let codeeditbox = cc.find("Canvas/smallsublayer/proxycode/codeeditbox");
            hqq.setNode(codeeditbox, { width: 251, height: 36, x: 90, y: -10 })
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(129, 129, 126, 255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(129, 129, 126, 255);
            cc.find("Canvas/smallsublayer/proxycode/codeeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
            cc.find("Canvas/smallsublayer/proxycode/headfram").active = false;
            ...
            this.num0 = 0;
            this.num1 = 0;
            this.versionlabel = cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/versionlabel").getComponent(cc.Label);
            ...
            let bindusdtAddress = cc.find("Canvas/smallsublayer/bindusdt/adress")
            ...
            let bindusdt = cc.find("Canvas/smallsublayer/bindusdt")
            hqq.addNode(bindusdt, { path: bpath + "4", zIndex: -1, width: 570, x: 90, y: 95, type: cc.Sprite.Type.SLICED })
            hqq.addNode(bindusdt, { path: bpath + "4", zIndex: -1, width: 460, x: 90, y: -25, type: cc.Sprite.Type.SLICED })
            hqq.setSprite(usdttitle, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "13", x: 0, y: 260 })
            hqq.addNode(bindusdt, { string: "usdtllx", x: -280, y: -25, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
            hqq.addNode(bindusdt, { string: "usdtqbdz", x: -290, y: 95, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
            // bindusdt.getChildByName("type").color = cc.color(84,98,119,255);
        ...
        switch (data.type) {
            ...
            case 3: // 修改昵称
                ...
                if (hqq.app.pinpai == "juding") {
                    ...
                    cc.find("Canvas/smallsublayer/nickchange/nickeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                    cc.find("Canvas/smallsublayer/nickchange/nickeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                } else if (hqq.app.pinpai == "huaxing") {
                    hqq.addNode(this.back, { path: "base/huaxing/img/d_tit", y: 260 })
                }
                break;
            ...
            case 16: // 设置
                ...
                this.onSettingMenuClick(cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz").getComponent(cc.Toggle), 1);
                this.panelInit(1)
                break;
            case 17:
    ...
    onSettingMenuClick(toggle, customEventData) {
        ...
        if (Number(customEventData) === 1) {
            this.sliderBGM = cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/sliderBGM").getComponent(hqqSlider);
            this.sliderSound = cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/sliderSound").getComponent(hqqSlider);
            ...
            cc.find("Canvas/smallsublayer/setting/btncontainer/ylsz/checkmark/yjks/yylxradio/toggle" + musicindex).getComponent(cc.Toggle).isChecked;
        } else if (Number(customEventData) === 2) {
            cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/getcodebtn/btnlabel").getComponent(cc.Label).string = hqq.getTip("sendcode");
            cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/getcodebtn/btnlabel").getComponent(cc.Label).string = hqq.getTip("sendcode");
            this.onSettingLoginTabCallback(cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1").getComponent(cc.Toggle), 1);
    ...
    onSettingAQMCallback() {
        let resetsurebtn = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/settinganiu").getComponent(cc.Button);
        let phonenum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/account").getComponent(cc.EditBox).string
        let yanzhenmanum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/captcha").getComponent(cc.EditBox).string
        let capchanum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/phone").getComponent(cc.EditBox).string
        let passnum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle2/checkmark/yjks/mmxg/password").getComponent(cc.EditBox).string
        if (phonenum == "") {
    ...
    onClickGetCaptcha(event, custom) {
        let phonenum
        let yanzhenmanum
        phonenum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle" + custom + "/checkmark/yjks/mmxg/account").getComponent(cc.EditBox).string
        yanzhenmanum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle" + custom + "/checkmark/yjks/mmxg/captcha").getComponent(cc.EditBox).string
        if (phonenum == "") {
            hqq.eventMgr.dispatch(hqq.eventMgr.showTip, hqq.getTip("showtip32"))
            return
        }
        ...
        let callback = (data) => {
            if (data.code == 200) {
                let btn = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle" + custom + "/checkmark/yjks/mmxg/getcodebtn").getComponent(cc.Button)
    ...
    // 重置账号密码 确定
    resetpassEnsure() {
        let resetsurebtn = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/settinganiu").getComponent(cc.Button);
        let phonenum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/account").getComponent(cc.EditBox).string
        let yanzhenmanum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/captcha").getComponent(cc.EditBox).string
        let capchanum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/phone").getComponent(cc.EditBox).string
        let passnum = cc.find("Canvas/smallsublayer/setting/btncontainer/dlmm/checkmark/tabToggleContainer/toggle1/checkmark/yjks/mmxg/password").getComponent(cc.EditBox).string
        if (phonenum == "") {
            hqq.eventMgr.dispatch(hqq.eventMgr.showTip, hqq.getTip("showtip32"))
            return
        }
